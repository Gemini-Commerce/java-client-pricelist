...
import GeminiCommerce_Pricelist.auth.Authentication;
import GeminiCommerce_Pricelist.auth.HttpBasicAuth;
import GeminiCommerce_Pricelist.auth.HttpBearerAuth;
import GeminiCommerce_Pricelist.auth.ApiKeyAuth;
import GeminiCommerce_Pricelist.auth.OAuth;
import GeminiCommerce_Pricelist.auth.RetryingOAuth;
import GeminiCommerce_Pricelist.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "https://pricelist.api.gogemini.io";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://pricelist.api.gogemini.io
     ...
     * @return a {@link GeminiCommerce_Pricelist.ApiClient} object
     */
     ...
     * @throws GeminiCommerce_Pricelist.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws GeminiCommerce_Pricelist.ApiException If fail to serialize the given object
     */
     ...
     * @throws GeminiCommerce_Pricelist.ApiException If fail to read file content from response and write to disk
     ...
     * @throws GeminiCommerce_Pricelist.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws GeminiCommerce_Pricelist.ApiException If the response has an unsuccessful status code or
     ...
     * @throws GeminiCommerce_Pricelist.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws GeminiCommerce_Pricelist.ApiException If fails to update the parameters
     */
     ...
     * @throws GeminiCommerce_Pricelist.ApiException If fail to serialize the request body object into a string
     */
