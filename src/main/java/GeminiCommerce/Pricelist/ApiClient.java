...
import GeminiCommerce.Pricelist.auth.Authentication;
import GeminiCommerce.Pricelist.auth.HttpBasicAuth;
import GeminiCommerce.Pricelist.auth.HttpBearerAuth;
import GeminiCommerce.Pricelist.auth.ApiKeyAuth;
import GeminiCommerce.Pricelist.auth.OAuth;
import GeminiCommerce.Pricelist.auth.RetryingOAuth;
import GeminiCommerce.Pricelist.auth.OAuthFlow;
...
public class ApiClient {
     ...
     * @return a {@link GeminiCommerce.Pricelist.ApiClient} object
     */
    ...
    */
     ...
     * @throws GeminiCommerce.Pricelist.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws GeminiCommerce.Pricelist.ApiException If fail to serialize the given object
     */
     ...
     * @throws GeminiCommerce.Pricelist.ApiException If fail to read file content from response and write to disk
     ...
     * @throws GeminiCommerce.Pricelist.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws GeminiCommerce.Pricelist.ApiException If the response has an unsuccessful status code or
     ...
     * @throws GeminiCommerce.Pricelist.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws GeminiCommerce.Pricelist.ApiException If fails to update the parameters
     */
     ...
     * @throws GeminiCommerce.Pricelist.ApiException If fail to serialize the request body object into a string
     */
